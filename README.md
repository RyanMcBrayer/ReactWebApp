# ReactWebApp
A web-based store app implemented using ReactJS and styled with React-Bootstrap  
...
### `npm install`
Run this once, the first time the project is installed.
(You need node installed to do this)
